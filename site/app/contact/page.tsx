...
export const metadata: Metadata = {
  ...
  description:
    "Contact Basecamp Brewing Co., find opening hours, get directions, or ask about bookings, live music, and group visits in Queenstown.",
  alternates: {
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-24 text-background sm:px-6 md:py-28 lg:px-8 lg:py-32">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-5 font-heading text-5xl uppercase leading-[0.92] sm:text-6xl lg:text-[4.5rem]">Find the taproom. Send a note. Make a plan.</h1>
